...
public class TextRoi extends Roi {
	...
	private Font instanceFont, globalFont;
	...
	Font getCurrentFont() {
		...
		if (newFont || mag!=previousMag) {
			globalFont = new Font(name, style, (int)(size*mag));
			previousMag = mag;
			newFont = false;
		}
		return globalFont;
