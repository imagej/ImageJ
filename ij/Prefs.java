...
public class Prefs {
	...
	private static final int USE_SYSTEM_PROXIES=1<<0, USE_FILE_CHOOSER=1<<1,
		...
		ASSUME_FIXED_DICOM_SCALING=1<<12,
		NON_BLOCKING_DIALOGS=1<<13, MODERN_MODE=1<<14;
	...
	*/
	...
	static void loadOptions() {
		...
		assumeFixedDicomScaling = (options2&ASSUME_FIXED_DICOM_SCALING)!=0;
	...
	static void saveOptions(Properties prefs) {
		...
		int options2 = (useSystemProxies?USE_SYSTEM_PROXIES:0)
			...
			+ (assumeFixedDicomScaling?ASSUME_FIXED_DICOM_SCALING:0)
