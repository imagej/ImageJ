 ...
 * RIFF                     'AVI 2.0' only: further chunks
 * |-AVIX
 *   |LIST movi             more movie data, as above, with ix00 index
...
public class AVI_Reader extends VirtualStack implements PlugIn {
    ...
    */
    ...
    /** Read AVIX for large files (beyond the first Chunk) **/
