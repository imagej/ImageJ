...
public class Benchmark implements PlugInFilter{
	...
	void showBenchmarkResults() {
		...
		tw.append("---------------------------------------------------------");
		tw.append(" 5.3   Pentium III/750, Win98 IE 5.0");
		tw.append(" 6.0   Pentium III/750, Win98 Netscape 4.7");
		tw.append(" 8.6   PPC G4/400, MacOS      MRJ 2.2");
		tw.append(" 9.1   Pentium II/400, Win95  JRE 1.1.8");
		tw.append(" 9.2   Pentium II/400, Win95  IE 4.0");
		tw.append(" 9.8   Pentium II/400, Linux  IBM JDK 1.1.8");
		tw.append("  11   Pentium II/400, Win95  JDK 1.2 (24% slower)");
		tw.append("  11   Pentium II/400, Win95  Netscape 4.5");
		tw.append("  14   PPC G3/300, MacOS      MRJ 2.1");
		tw.append("  21   Pentium II/400, Win95  JDK 1.3 (>2 times slower!!)");
