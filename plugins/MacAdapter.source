...
/** This Mac-specific plugin is designed to handle the “About ImageJ" and
   “Quit ImageJ" commands in the Apple menu and to open files dropped on
   ImageJ app and to open double-clicked files with creator code "imgJ".
   With Java 8, the “About ImageJ" and “Quit ImageJ” commands work
   without MacAdapter.
*/
