...
public class ImageWindow extends Frame implements FocusListener, WindowListener, WindowStateListener, MouseWheelListener {
	...
	public ImageWindow(ImagePlus imp, ij.gui.ImageCanvas ic) {
		super(imp.getTitle());
		if (SCALE>1.0) {
	...
	private void setLocationAndSize(boolean updating) {
		...
		double mag = 1;
		if (!(this instanceof ij.gui.PlotWindow)) { // unless a plot (always at 100%), zoom out to show all of image
	...
	public void setImage(ImagePlus imp2) {
		ij.gui.ImageCanvas ic = getCanvas();
	...
	public void updateImage(ImagePlus imp) {
        ...
        if (this instanceof ij.gui.StackWindow) {
        	ij.gui.StackWindow sw = (ij.gui.StackWindow)this;
        	int stackSize = imp.getStackSize();
